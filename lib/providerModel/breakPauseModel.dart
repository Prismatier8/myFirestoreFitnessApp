...
class BreakPauseModel extends ChangeNotifier {
  ...
  ///this class, when you are sure, that the init() was called.
  ...
  ///Manuel timer refresh, currently implemented when user hits breakPauseButton again while timer is running.
  ...
  ///Stops the timer from working in start() method
  _cancelTimer(){
      timer.cancel();
